...
**Dataframes as an argument**: `str()`,`head()`, `summarise()`, `group_by()`, `ggplot()`, `makeChart()`, `filter()`, `select()`, `sample_n()`, `join()`.

**Variables as an argument**: `mean()`, `max()`, `sqrt()`, `IQR()`, `+`, `==`, `>`, and so on.
