...
probAuthor: "Daniel Kaplan"
probDate: "August 11, 2014"
output:
  html_document:
...
![One of the RStudio tabs lists the objects in the "session environment." At the start, the environment is empty.](empty-environment.png)
...
![The first several cases (rows) and variables (columns) of the `NHANES` data table on body shape and health.](NHANES-table.png)
...
![The session environment after the NHANES data table has been loaded.](NHANES-environment.png)
...
![When the `SmallNHANES` object is created, it appears in the environment.](NHANES-small-environment.png)
