...
At first these concepts will seem abstract and confusing.  After an hour or so of using R, you will develop a more solid understanding.
...
We're going to use several packages.  The `DCFdevel` package contains data for the Data & Computing Fundamentals course.  In order to make these data accessible, you have to *load* the package.  The command is:
```{r}
library( DCFdevel )
```
