...
You don't need to use functions like `mScatter()` at all.  Here are a few [templates for different kinds of graphs](GraphicsTemplates.html).  Often, once you have chosen the kind of graph you want to make, modifications are as simple as changing the name of the data table and the variables.
