...
* Make a scatterplot map of the locations of the Medicare providers. (Hint: the ZIP code provides this information. You can translate it into latitude and longitude with `ZipGeography`.)  Overlay this on a choropleth map giving the population of each state.
