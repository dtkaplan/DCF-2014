...
Here are two data tables.  The left is the input to a data verb, the right is the output.  Identify the operation and write down the details of the operation.
