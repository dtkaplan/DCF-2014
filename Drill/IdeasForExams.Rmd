...
As from Week 6 `DatesAsNumbers.Rmd`, what will these statements do:
```{r eval=FALSE}
...
Mistakes %>% 
  ggplot( aes( y=hour(When),x=mistake)) + 
  geom_violin( ) + 
  facet_wrap( ~ Who )
```

Make a sketch showing roughly what the plot will look like.
